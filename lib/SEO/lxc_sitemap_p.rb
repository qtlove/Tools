...
out_file_name = "/home/sinasohubaidu/demo/public/sitemap-p.xml"
...
@products = Product.find(:all, :conditions => ["is_delete = ?", 0], :order => "updated_at DESC", :limit => 50000)
for p in @products
  loc        = "http://www.lxc360.com/product/#{p.id}"
