...
out_file_name = "/home/sinasohubaidu/demo/public/sitemap-p-c.xml"
#out_file_name = "sitemap-p-c.xml"
...
@product_categories = ProductCategory.find(:all, :conditions => ["parent_id in (20, 21) and is_delete = ?", 0])
for pc in @product_categories
  loc        = "http://www.lxc360.com/product/category/#{pc.id}"
  ...
  loc        = "http://www.lxc360.com/product/list/#{pc.id}"
  lastmod    = "#{Time.now.strftime("%Y-%m-%d")}"
  changefreq = "weekly"
  priority   = "0.5"
  #url
