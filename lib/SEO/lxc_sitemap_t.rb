...
out_file_name = "/home/sinasohubaidu/demo/public/sitemap-t.xml"
#out_file_name = "sitemap-t.xml"
...
@tags = ArticleTag.find(:all, :order => "created_at DESC", :limit => 50000)
for t in @tags
  loc        = "http://www.lxc360.com/article/tag/#{t.id}"
