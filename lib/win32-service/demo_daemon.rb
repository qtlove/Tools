...
begin  
   ...
   class DemoDaemon < Daemon
      ...
      #
      # In this particular case, I've setup a loop to write to append a
      # short message and timestamp to a file on your C: drive every 20
      # seconds. Be sure to stop the service when you're done!
      #
